...
class ScamBotProtection(commands.Cog):
    ...
    scamBotFilter = ["rl", "drop", "rlcs", "giveaway", "giveaways", "gift", "administration", "rltracker", "psyonix", "gifts", "g1fts", "quickselling", "gamersrdy", "rltracker","rlgarage", "rewards"]
    ...
    imagesHashes = [
        ...
        imagehash.average_hash(Image.open('data/scambot_protection/18.png'))
    ...
    similarityMatch = 5 #Adjust this number. Lower => Image needs to be more similar to one of the blacklisted avatars
    similarityMatchLax = 13
